...
const config = {
    serverInfo: {
        ...
        serverName: "MAZEMC NETWORK", /*Server name*/
        serverIp: "PLAY.MAZEMC.ES", /*Server IP (if you want to add online user counter, you must have true the enable-status and enable-query of server.properties)*/
        discordServerID: "1179241471447138345" /*Your server ID (if you want to add online user counter, you must have enabled Discord server widget)*/
    },
    ...
    All skins for original players are generate automaticaly. If you want to add skins to warez players, yout must add url for skin to skinUrlOrPathToFile
        {
            inGameName: "TortaDePollo",  <--- In-Game name
            rank: "Owner",  <-- rank
